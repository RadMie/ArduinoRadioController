...
void LCD::mainMenu(uint8_t positionNumber) {
  ...
  static const unsigned char PROGMEM icoSystem[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, };
  static const unsigned char PROGMEM icoMPU6050[] = {
    , };
  static const unsigned char PROGMEM icoProcessing[] = {
    , };

  if(positionNumber > 15) positionNumber = 15;
  ...
  switch(positionNumber) {
    ...
    case 14:  // MPU6050
      setCursor(19,0);
      print("MPU6050");
      drawBitmap(22, 10, icoMPU6050, 40, 28, BLACK);
      setCursor(24,40);
      print("Select");
      break;
    case 15:  // Processing
      setCursor(14,0);
      print("Processing");
      drawBitmap(22, 10, icoProcessing, 40, 28, BLACK);
      setCursor(24,40);
      print("Select");
      break;
  }
...
void LCD::subMenuMPU6050(uint8_t accRXRY, int pos, boolean sel) {
  ...
  if(pos == 1){if(!sel){ fillRect(2,10,31,9,BLACK); setTextColor(WHITE); setCursor(3,11); print("Mode:"); setTextColor(BLACK); setCursor(52,11); print(mode); }else{ fillRect(51,10,19,9,BLACK); setTextColor(BLACK); setCursor(3,11); print("Mode:"); setTextColor(WHITE); setCursor(52,11); print(mode); }}else{ setTextColor(BLACK); setCursor(3,11); print("Mode:"); setCursor(52,11); print(mode); }
  
  display();
}

void LCD::subMenuProcessing(uint8_t proccesing, uint8_t speedserial, int pos, boolean sel) {
  ...
  if(pos == 1){if(!sel){ fillRect(2,10,31,9,BLACK); setTextColor(WHITE); setCursor(3,11); print("Mode:"); setTextColor(BLACK); setCursor(52,11); print(mode); }else{ fillRect(51,10,19,9,BLACK); setTextColor(BLACK); setCursor(3,11); print("Mode:"); setTextColor(WHITE); setCursor(52,11); print(mode); }}else{ setTextColor(BLACK); setCursor(3,11); print("Mode:"); setCursor(52,11); print(mode); }
  if(pos == 2){if(!sel){ fillRect(2,19,31,9,BLACK); setTextColor(WHITE); setCursor(3,20); print("Baud:"); setTextColor(BLACK); setCursor(37,20); print(spee); }else{ fillRect(36,19,37,9,BLACK); setTextColor(BLACK); setCursor(3,20); print("Baud:"); setTextColor(WHITE); setCursor(37,20); print(spee); }}else{ setTextColor(BLACK); setCursor(3,20); print("Baud:"); setCursor(37,20); print(spee); }
